...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="admin\template\pages\icons/logo1.png" />
</head>
<body>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/tables/lapangan.php">
              <i class="ti-view-list-alt menu-icon"></i>
              <span class="menu-title">Data Lapangan</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="pages/tables/employe.php">
              <i class="ti-view-list-alt menu-icon"></i>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">ZonaFutsal Dashboard</h4>
                </div>
                <div>
          ...
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-xl-left">Income</p>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-xl-left">Outcome</p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
            ...
            <div class="col-md-7 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="text-muted font-weight-light">Jumlah penyewaan lapangan di ZonaFutsal pada setiap harinya dalam sebulan.</p>
                  ...
                  <div class="d-flex justify-content-center justify-content-md-end">
                    ...
                    <script>
                      ...
                      var myChart = new Chart(ctx, {
                        type: 'bar',
                        data: {
                          labels: ["Senin", "elasa", "Ekonomi", "Pertanian"],
                          datasets: [{
                            label: '',
                            data: [
                            <?php 
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal"href="index.php">Cancel</button>
